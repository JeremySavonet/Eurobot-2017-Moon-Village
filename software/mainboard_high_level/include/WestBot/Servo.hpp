...
#define SERVO_0_ARM_R_OPEN45 (26200) // ouvert à 45° (utile après ejection car 90° trop large)
...
#define SERVO_6_ARM_L_OPEN45 (19000) // ouvert à 45° (utile après ejection car 90° trop large)
