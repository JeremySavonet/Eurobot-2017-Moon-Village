...
RobotPos Recallage::sendPos( const RobotPos& robotPos )
{
	RobotPos pos;
...
void Recallage::errorInit( double errX, double errY, double errTheta )
{
	error.x = errX;
	error.y = errY;
...
void Recallage::errorModify( double errX, double errY, double errTheta )
{
